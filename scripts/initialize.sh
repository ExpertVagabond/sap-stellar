...
echo "  Registry:   https://testnet.stellar.expert/explorer/testnet/contract/$REGISTRY_CONTRACT"
echo "  Work Order: https://testnet.stellar.expert/explorer/testnet/contract/$WORK_ORDER_CONTRACT"
echo "  Reputation: https://testnet.stellar.expert/explorer/testnet/contract/$REPUTATION_CONTRACT"
